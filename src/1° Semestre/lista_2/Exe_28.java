...
public class Exe_28 {
    public static void main(String[] args) {
        ...
        double precoTotal = 0, valorDesconto = 0, precoFinal = 0;
...
/*
    ...
    Atenção: Para atender a todos os clientes, cada cliente poderá levar apenas um dos tipos de
    carne da promoção, porém não há limites para a quantidade de carne por cliente. Se compra for
    ...
    cupom fiscal, contendo as informações da compra: tipo e quantidade de carne, preço total, tipo de
